...
function wpbb_enqueue_style() {         
    ...
    if(is_single()){
        ...
        $template_slug = str_replace(' ', '-', strtolower(wpbb_get_template_name()));
    }    
...
add_action( 'wp_enqueue_scripts', 'wpbb_enqueue_style' );
add_action( 'wp_enqueue_scripts', 'wpbb_enqueue_script' );